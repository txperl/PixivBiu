...
from .model.dler_aria2 import Aria2Dler
from .model.dler_dl import DlDler
from .model.dler_dl_single import DlSingleDler
from ...platform import CMDProcessor


@CMDProcessor.core_register_auto("dl", {"config": "{ROOTPATH}config.yml"})
class core_module_dl(object):
    def __init__(self, info=None):
        self.WAYS = {"aria2": Aria2Dler, "dl": DlDler, "dl-single": DlSingleDler}
        self.modName = None
        self.mod = None
        self.sets = info["config"]
        self.ENVIRON = info["ENVIRON"]
        self.tasks = {}
