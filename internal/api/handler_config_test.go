...
func TestRestartConfig_TriggersRestartWhenAuthed(t *testing.T) {
	var fired int
	// hub/dl/pkce/heartbeat/searchSamplePages/searchSampleConcurrency/cfgMgr/upd/img are unused by RestartConfig.
	h := NewHandler(authedService(t), nil, nil, nil, nil, nil, nil, nil, func() { fired++ }, nil, nil, "")
...
func TestRestartConfig_RequiresAuth(t *testing.T) {
	...
	var fired int
	h := NewHandler(svc, nil, nil, nil, nil, nil, nil, nil, func() { fired++ }, nil, nil, "")
